...
**Status:** 완료 — 2026-07-22 구현·문서 동기화와 전체 검증을 마쳤다.

**Completion Evidence:** Vitest unit 25개 파일·158건, integration 5개 파일·33건, Chromium E2E 21건, lint, typecheck, production build가 통과했다.
...
- [x] **Step 1: profile 변환과 연령 경계 RED 작성**
...
- [x] **Step 1: load·save·연령·입력 보존 component RED 작성**
...
- [x] **Step 3: 주입 가능한 ProfileScreen 구현**
...
- [x] **Step 1: abort·timer·generation RED 작성**
...
- [x] **Step 4: unit과 기존 이중 guard integration GREEN 확인**
...
- [x] **Step 1: 확인·취소·rollback·성공 상태 RED 작성**
...
- [x] **Step 3: reset orchestration 구현**
...
- [x] **Step 4: UI·integration GREEN 확인**
...
- [x] **Step 1: 최신 manual 복원과 마지막 답변 transaction RED 작성**
...
- [x] **Step 3: input type과 repository signature 추가**
...
- [x] **Step 5: repository 전체 GREEN 확인**
...
- [x] **Step 1: 질문 내용·상한·비권고 summary RED 작성**
...
- [x] **Step 1: 생성·복원·중복 제출·실패 보존 RED 작성**
...
- [x] **Step 3: application service 구현**
...
- [x] **Step 5: 홈 버튼을 actual route로 연결**
...
- [x] **Step 1: 수동 문진 복원·완료 E2E RED 작성**
...
- [x] **Step 2: 프로필 snapshot 불변 E2E RED 작성**
...
- [x] **Step 6: 전체 정적·unit·integration gate**
...
- [x] **Step 7: 전체 E2E와 production build**
