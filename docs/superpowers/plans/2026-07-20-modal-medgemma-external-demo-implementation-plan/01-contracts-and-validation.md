...
- [x] **Step 1: 허용/거절 DTO와 식별정보 테스트를 작성한다**
...
- [x] **Step 3: exact-object validator를 구현한다**
...
- [x] **Step 5: UI 질문·persona와 command port를 공유 계약으로 옮긴다**
