...
- [x] **Step 1: HTTP command와 전환 테스트를 작성한다**
...
- [x] **Step 3: 질문 slot과 persona를 fixture 전체에 채운다**
...
- [x] **Step 5: demo와 fixture adapter를 분리 연결한다**
...
검증(2026-07-21): 관련 단위 테스트 10개 파일·85건, lint, typecheck가 통과했다. prototype key persona 거절, 빈 history의 demo 시작, fixture/demo 네트워크 분리, abort를 무시한 transport의 stale 응답 폐기를 포함한다. Modal 배포·실제 GPU 호출·commit·push는 수행하지 않았다.
