...
export interface MedGemmaProvider {
  requestQuestion(context: AiInterviewContextV1, signal: AbortSignal): Promise<AiQuestionResponseV1>;
  requestSummary(context: AiInterviewContextV1, signal: AbortSignal): Promise<AiSummaryResponseV1>;
}
```

- [ ] **Step 1: adapter mapping 테스트를 작성한다**
...
- [ ] **Step 2: Route Handler guard 테스트를 작성한다**
...
- [ ] **Step 4: server-only provider factory와 adapter를 구현한다**
